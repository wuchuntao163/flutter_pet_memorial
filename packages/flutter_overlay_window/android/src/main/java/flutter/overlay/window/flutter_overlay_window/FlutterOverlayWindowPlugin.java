...
public class FlutterOverlayWindowPlugin implements
    ...
    public void onMethodCall(@NonNull MethodCall call, @NonNull Result result) {
        ...
        if (call.method.equals("checkPermission")) {
            ...
            Map<String, Object> startPosition = call.argument("startPosition");
            int startX = OverlayConstants.DEFAULT_XY;
            int startY = OverlayConstants.DEFAULT_XY;
            if (startPosition != null) {
                Object xObj = startPosition.get("x");
                Object yObj = startPosition.get("y");
                if (xObj instanceof Number) {
                    startX = ((Number) xObj).intValue();
                }
                if (yObj instanceof Number) {
                    startY = ((Number) yObj).intValue();
                }
            }
